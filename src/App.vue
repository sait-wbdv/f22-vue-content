...
<template>
  <header
    class="flex items-center justify-between bg-gradient-to-r from-violet-500 via-emerald-500 to-emerald-700 p-4 md:px-8"
  >
  ...
  <!-- RouterView shows the content from your pages or "views" -->
  <RouterView />
